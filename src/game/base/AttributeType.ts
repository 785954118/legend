...
enum AttributeType {
	...
	atJob3HpEx = 30,				//30,道士生效,对最大生命万份比倍率
	atNeiGongRestore = 31,   	//31,定时恢复内功值
	// atDamageEnhanceToWarrior,   // 攻击战士伤害加深
	// atDamageEnhanceToMage,   // 攻击法师伤害加深
	// atDamageEnhanceToTaoist,   // 攻击道士伤害加深
	// atDamageReductionByWarrior, // 受到战士伤害减免
	// atDamageReductionByMage, // 受到法师伤害减免
	// atDamageReductionByTaoist, // 受到道士伤害减免
	atVamirePro = 32, //传世装备，攻击时吸血的概率（万分比）
	atVamirePen = 33, //传世装备，攻击时吸血的傷害比例（万分比）
	atVamireCd = 34, //传世装备，攻击时吸血的CD（毫秒）

	atCursePro = 35, //传世装备，詛咒概率（万分比）
	atCurseCd = 36, //传世装备，詛咒CD（毫秒）
	atAttAddDamPro = 37, //37.攻击增加伤害的概率(万份比)(兵魂1)
	atAttAddDamVal = 38, //38.攻击增加伤害的值(兵魂1)
	atBeAttAddHpPro = 39,//39.受到攻击时候恢复生命的概率(万份比)(兵魂2)
	atBeAttAddHpVal = 40,//40.受到攻击时候恢复生命的值(兵魂2)
	atAttMbAddDamPen = 41,//41.对被麻痹的目标额外造成X%伤害提升(兵魂4)
	atHpLtAddBuff = 42,	//42.生命低于(万分比例)时,触发生命恢复buff(兵魂5)
	atAttHpLtPenAddDam = 43,//43.攻击生命低的目标增加伤害的血量比例(万份比)(兵魂6)
	atAttHpLtAddDamPen = 44,//44.攻击生命低的目标增加伤害比例(万份比)(兵魂6)
	...
	atAttPerDamPan = 54, //54.命中时追加当前伤害50%的额外伤害的机率(万份比)(兵魂3)
	atYuPeiDeterDam = 55,//55.玉佩的威慑技能加深伤害万份比
	atCritEnhanceResist = 56, // 56,暴击伤害抵抗率
	atHolyDamege = 57,		//57.神圣伤害固定值
	atHolyMaster = 58,		//58.神圣伤害精通率(万分比)
	atHolyResist = 59,		//59.神圣伤害抵抗率(万分比)
	atTogetherHolyDamege = 60,		//60.合击神圣伤害固定值
	atTogetherHolyMaster = 61,		//61.合击神圣伤害精通率(万分比)
	atTogetherHolyResist = 62,		//62.合击神圣伤害抵抗率(万分比)
	atZhuiMingPro = 63,		//63.触发追命伤害的概率(万分比) 心法系统
	atZhuiMingVal = 64,		//64.追命伤害(固定值) 心法系统
	...
	atAddEnemyHp = 70,		//70.自己被打后给对方加血(固定值)
	atHurtMyself = 71,		//71.攻击对方后自己掉血(万份比)
	...
	atHearthCount, //84.心法3每N次触发82or83
	atCount,
}
