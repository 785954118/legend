class GuildManagePanel extends BaseComponent {
	...
	private updateList(): void {
		...
		this.buildList.dataProvider = new eui.ArrayCollection([GuildBuilding.GUILD_HALL, GuildBuilding.GUILD_LIANGONGFANG, GuildBuilding.GUILD_COMMENT, GuildBuilding.GUILD_SHOP]);//, GuildBuilding.GUILD_SHOP
		this.refushBar();
	}
