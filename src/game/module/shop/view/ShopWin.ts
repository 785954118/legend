...
class ShopWin extends BaseEuiView {
	...
	public NobleshopSkin:NobleShopPanel;


	private lastIndex: number = 0;
	// public integrationPanel: IntegrationPanel;
	...
	constructor() {
		...
		// this.setSkinPart("NobleshopSkin", new NobleShopPanel());
	...
	private setOpenIndex(selectedIndex: number): void {
		switch (selectedIndex) {
			...
			case 1:
				this.itemShopPanel.open();
				// this.NobleshopSkin.open(this.scrollBottom);
				break;
			case 2:
