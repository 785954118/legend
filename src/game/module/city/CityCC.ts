...
class CityCC extends BaseSystem {
    ...
    /** BOSS 击杀次数信息 */
    public bossKillNumData: { [id: number]: [number, number] } = {};
    ...
    public postBossInfo(bytes: GameByteArray) {
    ...
    public postCityBossId(bytes: GameByteArray) {
