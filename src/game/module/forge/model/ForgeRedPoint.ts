...
class ForgeRedPoint extends BaseSystem {
    ...
    constructor(){
        ...
        // this.associated(this.postForgeMergeRedPoint,
    ...
    public postForgeRedPoint(){
        ...
        this.redPoint = this.tabs[ForgeWin.Page_Select_Boost] ||
            ...
            // this.tabs[ForgeWin.PageSelectSamsara];
    ...
    // public postForgeMergeRedPoint() {
    //     let tab = ForgeWin.PageSelectSamsara;
    //     let old = this.tabs[tab];
    //     let b:boolean = false;
    //     if (MergeCC.ins().isOpen()) {
    //         b = MergeCC.ins().redPoint();
    //     }
    //     this.tabs[tab] = b;
    //     return b != old;
    // }
