...
class OSATarget7Panel extends ActivityPanel {
	...
	public open(...param: any[]): void {
		...
		if (!this.type2PanelList[this.activityID]) {
			...
			let panel: ActivityPanel = ObjectPool.pop(`OSATarget7Panel${showType == ActivityType7Data.TYPE_RING || showType == ActivityType7Data.TYPE_HEFUBOSS || showType == ActivityType7Data.TYPE_CELEBREATE? 1 : showType}`);
			panel.top = 0;
			panel.bottom = 0;
			panel.left = 0;
			panel.right = 0;
