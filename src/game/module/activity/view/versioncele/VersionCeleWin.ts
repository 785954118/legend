 ...
 *    版本庆典活动
 */
class VersionCeleWin extends BaseEuiView {
	public roleSelect: BaseComponent;
	public viewStack: eui.ViewStack;
	public fiveDaySkin: BaseComponent;
	public FDStoreSkin: BaseComponent;
...
ViewManager.ins().reg(VersionCeleWin, LayerManager.UI_Main);